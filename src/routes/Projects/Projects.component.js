...
import ReadMoreSection from '../../common-components/ReadMoreSection/ReadMoreSection.component';
    ...
    return (
      <section className="project-page" id="main">
        ...
        <p>
          ...
          process.
          <br />
          Since the original build, I've continually added, modified, and 
          refactored portions of the project to improve both the intuitive 
          nature of the code, and improve how I might add content.
          <br />
        ...
        <p class="award clearfix">
          <div class="award-div">
            Best Everyday Hack - PowerAdvocate | Most Entrepreneurial Hack - Rough Draft Ventures
          </div>
          <div class="award-opener">
            Awards: 
          </div>
        </p>
        <p class="team-members clearfix">
