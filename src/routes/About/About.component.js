    ...
    return (
      <section className="about-page" id="main">
        ...
        <p>
          ...
          passionate about building, iterating upon, and optimizing solutions. I
          was born in Canada, grew up in Hong Kong, and studied for a year back
          in Canada before moving to Boston. My interest in computer science was
          solidified during my first university lecture and since then I've had
          the opportunity to continuously grow and develop in the field. My
          interests currently lie in full-stack web development, AI, distributed
          systems, game development, and robotics.
          <br />
          <br />
